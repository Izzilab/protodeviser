...
var GraphicGenerator = Class.create( {
  ...
  generate: function() {
    ...
    this._pg.setImageParams( {
      // use one for both X and Y. Adjust X by residueWidth. -petar
      //xscale: $F("xscale"),
      //yscale: $F("yscale"),
      xscale: $F("scale"),
      yscale: $F("scale"),
      residueWidth: $F("residueWidth"),
      // Better do not mess with the next 4, but make motifOpacity adjustable. -petar
      //regionHeight: $F("regionHeight"),
      //motifHeight: $F("motifHeight"),
      //envOpacity: $F("envOpacity"),
